---
title: "Transition and Survival visualizations"
...
dat <- dat %>% mutate(
  ...
  surv_time = rexp(nrow(.), lambda(M_next, W_next, tumor_mass, toxicity, dose, c1 = 1.5, c2 = 1.5)),
  expected_surv = 1/lambda(M_next, W_next, tumor_mass, toxicity, dose, c1 = 1.5, c2 = 1.5),
  dead = ifelse(dead,
                T,
                surv_time < 1)
)
