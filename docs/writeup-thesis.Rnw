...
<<ex-cart-tree, fig.cap=caption, fig.scap='Regression tree fit to example data', fig.lp='fig:', fig.width='0.9\\textwidth', fig.height=5, dev.args=list(pointsize=13)>>=
...
<<ex-plot-cart, fig.cap=caption, fig.scap='Predicted regression function for example data using CART', fig.lp='fig:', fig.height=3, fig.width=5>>=
...
<<ex-plot-mars, fig.cap=cap, fig.scap='Predicted regression function for example data using MARS', fig.lp='fig:'>>=
...
<<ex-plot-rf, fig.cap=cap, fig.scap='Predicted regression function for example data using Random Forest', fig.lp='fig:'>>=
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=\textwidth]{extras/efigure/results-no-int-1}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=\textwidth]{extras/efigure/results-int-1}
