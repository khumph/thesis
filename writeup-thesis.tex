...
\begin{multline}
    Q^{*}_{k}(s, a) = \operatorname{E}\sbr{R_{k+1} \mid S_k = s, A_k = a} + \\ \sum_{s' \in \mathcal{S}} \max_{a'} Q_{k+1}(s', a') % \pi(s', a') 
