...
\begin{figure}[!tbp]
\begin{center}
\includegraphics[width=\textwidth]{results-plot-no-int-3.png}
\end{center}
...
\begin{figure}[!tbp]
\begin{center}
\includegraphics[width=\textwidth]{results-plot-int-3.png}
\end{center}
...
%latex.default(r_tab, file = "", rowname = NULL, colheads = labs,     booktabs = T)%
\begin{table}[!tbp]
\begin{center}
\begin{tabular}{lllllll}
\toprule
